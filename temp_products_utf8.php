...
<body>
        ...
        <header class="page-header">
            <div class="header-title">
                ...
                <div style="margin-top: 10px;">
                    <a href="index.php" style="color: var(--text-muted); font-size: 0.9rem; text-decoration: none;">ΓåÉ
                        Back to Dashboard</a>
                </div>
            </div>
                    ...
                    <?php if (empty($products)): ?>
                        <tr>
                            <td colspan="5" style="text-align: center; padding: 5rem;">
                                <span style="font-size: 3rem; opacity: 0.1; display: block; margin-bottom: 1rem;">≡ƒì╖</span>
                    ...
                    <?php else: ?>
                        <?php foreach ($products as $p): ?>
                            <tr>
                                <td>
                                    <div class="product-cell">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <span><?php echo htmlspecialchars($p['type']); ?> ΓÇó
                                ...
                                <td>
                                    <span class="price-tag">Γé▒<?php echo number_format($p['price'], 2); ?></span>
                                </td>
    ...
    <script>
        ...
        function openProductModal(data) {
            ...
            document.getElementById('modal-price').innerText = 'Γé▒' + parseFloat(data.price).toLocaleString(undefined, { minimumFractionDigits: 2 });
